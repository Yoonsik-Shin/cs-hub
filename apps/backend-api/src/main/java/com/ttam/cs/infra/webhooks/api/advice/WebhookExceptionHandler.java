package com.ttam.cs.infra.webhooks.api.advice;
...
import com.ttam.cs.infra.webhooks.api.WebhookController;
...
public class WebhookExceptionHandler {
    ...
    public ResponseEntity<KakaoChatbotSkillResponse> handleNoSuchSkillHandler(NoSuchSkillHandlerException ex) {
        log.warn("NoSuchSkillHandlerException occurred: {}", ex.getMessage());
