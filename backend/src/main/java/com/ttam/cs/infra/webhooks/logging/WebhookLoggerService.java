...
public class WebhookLoggerService {
    ...
    private static final Logger skillLogger = LoggerFactory.getLogger("com.ttam.cs.infra.webhooks.logging.SkillLogger");
    private static final Logger validationLogger = LoggerFactory.getLogger("com.ttam.cs.infra.webhooks.logging.ValidationLogger");
